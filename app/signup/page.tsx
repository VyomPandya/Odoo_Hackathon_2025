    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-secondary-50 to-secondary-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          <a href="/" className="inline-flex items-center text-secondary-600 hover:text-primary-600 transition-colors mb-8">
        ...
        <div className="card">
                ...
                <div className="mt-2 space-y-1">
                  {passwordRequirements.map((req, index) => (
                    <div key={index} className="flex items-center text-sm">
                      <Check 
                        className={`mr-2 ${req.met ? 'text-green-500' : 'text-secondary-300'}`} 
                        size={16} 
                      />
                      <span className={req.met ? 'text-green-600' : 'text-secondary-500'}>
                        {req.label}
                      </span>
                    </div>
                  ))}
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button className="btn-outline w-full py-2 px-4 flex items-center justify-center">
