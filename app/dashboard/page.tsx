...
export default function DashboardPage() {
  ...
  // Persist dark mode in localStorage and respect system preference
  useEffect(() => {
                    ...
                    {showSettings && (
                      <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg shadow-lg z-50 p-4">
                        ...
                        <ul className="text-sm text-slate-700 dark:text-slate-200 space-y-2">
                          ...
                          <li><button className="hover:underline w-full text-left" onClick={handleLogout}>Logout</button></li>
                        </ul>
              ...
              <div className="w-full mb-4 lg:mb-0 lg:col-span-1">
                <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 p-6">
                  ...
                  <div className="space-y-3">
                    <button onClick={() => setShowAskModal(true)} className="w-full bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white font-medium py-3 px-4 rounded-xl transition-colors flex items-center justify-center">
                      <Plus className="mr-2" size={16} />
                      Ask Question
                    </button>
                    {/* Removed View Trends button */}
                  </div>
                </div>
